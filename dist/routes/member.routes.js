...
router.post('/request/respond', auth_middleware_1.authenticateToken, memberController.respondToJoinRequest);
router.post('/ban', auth_middleware_1.authenticateToken, memberController.banMember);
router.post('/unban', auth_middleware_1.authenticateToken, memberController.unbanMember);
